                                ...
                                while enemyl_1 >= 1:
                                    ...
                                    if attack == "1":
                                        ...
                                        if enemy == "awake":
                                            ...
                                            print("You silently walk over to the troll. You are about to slit his throat when he wakes up. You still manage to get a good slash at him before he wakes.".center(150))
                                            enemy = "drowzy"
                                            proficiency_1 = proficiency_1 + 2
                                            enemyl_1 = enemyl_1 - proficiency_1
                                            proficiency_1 = proficiency_1 - 2
                                    ...
                                    while forest == 1:
                                        ...
                                        while While_5 == 1:
                                            ...
                                            if building_choice == "2":
                                                ...
                                                building_2 = 1
                                                while building_2 == 1:
                                                    print("Do you ask him for food(1), ask if he has any jobs for you to do(2), or leave(3)".center(150))
                                                    tc = input(" ")
                                                    if tc == "1":
